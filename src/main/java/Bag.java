...
public abstract class Bag {
    ...
    public String popItem(){
        if (this.numberOfContents == 0){
            ...
            String removed = this.contents[numberOfContents];
    ...
    public void increaseCapacity(int n) {
        int new_capacity = this.capacity + n;
        String[] new_bag = new String[new_capacity];
        String[] old_bag = this.contents.clone();
